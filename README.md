...
- OpenRouter cost calculator: [free editable estimator for OpenRouter or LLM API spend, cache-read share, retry overhead, and tool-call fanout](https://jackjin1997.github.io/agent-audit-sprint/openrouter-cost-calculator.html); copy a sanitized packet to the USD $99 TokenMeter quick audit, USD $299 Cost Leak review, or USD $1,000 emergency sprint before any payment.
