...
- AI music order desk: [ready-buyer desk for choosing use case, package, reference sample, contact, source-rights context, CTA, and creative notes](https://jackjin1997.github.io/agent-audit-sprint/ai-music-order-desk.html), then generating an email/GitHub order packet plus after-acceptance payment handoff before payment.
